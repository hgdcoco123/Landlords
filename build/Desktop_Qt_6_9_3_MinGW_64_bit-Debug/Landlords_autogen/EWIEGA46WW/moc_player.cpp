...
template <> constexpr inline auto Player::qt_create_metaobjectdata<qt_meta_tag_ZN6PlayerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(Player *, int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { QMetaType::Int, 5 },
        }}),
        // Signal 'notifyPlayHand'
        QtMocHelpers::SignalData<void(Player *, Cards)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { 0x80000000 | 7, 8 },
        }}),
        // Signal 'notifyPickCards'
        QtMocHelpers::SignalData<void(Player *, Cards)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { 0x80000000 | 7, 10 },
        }}),
    };
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Player::*)(Player * , int )>(_a, &Player::notifyGrabLordBet, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(Player * , Cards )>(_a, &Player::notifyPlayHand, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(Player * , Cards )>(_a, &Player::notifyPickCards, 2))
            return;
    }
}
