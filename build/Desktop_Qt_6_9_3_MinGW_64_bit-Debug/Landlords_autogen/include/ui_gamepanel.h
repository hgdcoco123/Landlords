...
public:
    ...
    void setupUi(QMainWindow *GamePanel)
    {
        ...
        GamePanel->resize(577, 500);
        GamePanel->setMinimumSize(QSize(0, 0));
        GamePanel->setMaximumSize(QSize(16777215, 500));
        ...
        horizontalSpacer = new QSpacerItem(259, 28, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
